...
const requiredTrue=['claudeAlive','workspaceRoot','tmuxIdentity','singleManagedClaude','helperAlive','helperParentMatches','oldHelperAbsent','helperIdentityMatches','runtimeConnected','frontendMcpConnected','modelExact','noModelFallback','transcriptParseable','permissionsIntact','hooksIntact','claudeMdAvailable'];
