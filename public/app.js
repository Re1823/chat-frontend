...
function renderChatMessage(message,previous){
  if(message.role==='assistant'&&!message.pending&&!message.content&&!message.images?.length&&!message.toolMessages?.length&&!message.thoughtProcess?.items?.length&&!message.delivery?.notice)return '';
